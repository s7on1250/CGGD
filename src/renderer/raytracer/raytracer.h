...
namespace cg::renderer
{
			...
			const VB& vertex_a, const VB& vertex_b, const VB& vertex_c)
	{
		...
		ambient = {vertex_a.ambient_r, vertex_a.ambient_g, vertex_a.ambient_g};
		diffuse = {vertex_a.diffuse_r, vertex_a.diffuse_g, vertex_a.diffuse_g};
		emissive = {vertex_a.emissive_r, vertex_a.emissive_g, vertex_a.emissive_g};
	}
